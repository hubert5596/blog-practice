<template>
  <div>
    <div class="edit_wrap">
      ...
      <div class="edit_head">profile</div>
      <el-input
          type="textarea"
          :rows="5"
      ...
      <div class="edit_head">content (Markdown)</div>
      <div class="markdown">
      ...
      <div class="save_button">
        <el-button type="primary" @click="saveArticle">save</el-button>
      </div>
    </div>
  </div>
</template>
      ...
      saveArticle: function () {
        ...
        if (this.$route.params.id) {
          ...
          this.$http.post('/api/admin/saveArticle', {
            ...
            response => {
              self.$message({
                message: 'Published articles successfully',
                type: 'success'
              })
              // 保存成功后跳转至文章列表页
